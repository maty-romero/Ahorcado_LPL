                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="fechaNacimiento"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Fecha nacimiento') }}</label>
                                <div class="col-md-6">
                                    <input id="fechaNacimiento" type="date" class="form-control" name="fechaNacimiento"
                                        value="{{ old('fechaNacimiento') }}" autocomplete="fechaNacimiento" required>
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="paisResidencia"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Pais de Residencia') }}</label>
                                <div class="col-md-6">
