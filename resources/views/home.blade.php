...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center mt-4">
            ...
            <div class="col-md-4 mb-4 d-flex justify-content-center">
                <a type="button" class="btn btn-danger btn-lg" href="{{ route('index_interrumpidos') }}">Retomar juego
                    interrumpido</a>
            </div>
        </div>
    </div>
    ...
    <style>
        ...
        .hide {
            ...
            /* Añade una transición suave para una animación de desvanecimiento */
        }
    </style>
